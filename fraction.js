// fraction.js — fenêtre d'ajout 1/4, 1/2, 3/4 de tour (self-contained)

// Helpers locaux (indépendants de course.js)
...
window.ajouterFraction = function (eleve, longueurTour) {
  // fallback longueur si manquante
